...
from src.dashboard.layouts.chart_components import create_empty_chart, create_horizontal_bar_chart
...
# Helper functions - using functions from chart_components module
