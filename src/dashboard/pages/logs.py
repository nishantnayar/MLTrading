...
from ..components.log_viewer import (
...
def create_layout():
    ...
    Returns:
        Dash layout for logs page
    """
    return html.Div([
        html.Div([
            html.H2("System Logs", className="mb-4"),
            html.P("View and filter system logs from all components with enhanced analytics.", className="text-muted mb-4")
